...
Add new public guides here. Label proposals, historical tests and release-specific behavior. Link to actual source/test evidence; do not infer released behavior from an open PR. Keep device-specific paths, hostnames, credentials, transcripts, account IDs and private operating records outside public Git. Public examples should use neutral placeholders.
