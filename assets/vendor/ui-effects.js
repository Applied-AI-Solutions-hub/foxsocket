(()=>{var it=()=>({checkValidity(e){let t=e.input,o={message:"",isValid:!0,invalidKeys:[]};if(!t)return o;let a=!0;if("checkValidity"in t&&(a=t.checkValidity()),a)return o;if(o.isValid=!1,"validationMessage"in t&&(o.message=t.validationMessage),!("validity"in t))return o.invalidKeys.push("customError"),o;for(let r in t.validity){if(r==="valid")continue;let i=r;t.validity[i]&&o.invalidKeys.push(i)}return o}});var nt=class extends Event{constructor(){super("wa-invalid",{bubbles:!0,cancelable:!1,composed:!0})}};var Ke=Object.defineProperty,Ge=Object.getOwnPropertyDescriptor,Wt=e=>{throw TypeError(e)},s=(e,t,o,a)=>{for(var r=a>1?void 0:a?Ge(t,o):t,i=e.length-1,n;i>=0;i--)(n=e[i])&&(r=(a?n(t,o,r):n(r))||r);return a&&r&&Ke(t,o,r),r},Xt=(e,t,o)=>t.has(e)||Wt("Cannot "+o),Yt=(e,t,o)=>(Xt(e,t,"read from private field"),o?o.call(e):t.get(e)),Kt=(e,t,o)=>t.has(e)?Wt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,o),Gt=(e,t,o,a)=>(Xt(e,t,"write to private field"),a?a.call(e,o):t.set(e,o),o);var st=globalThis,lt=st.ShadowRoot&&(st.ShadyCSS===void 0||st.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,_t=Symbol(),Zt=new WeakMap,H=class{constructor(t,o,a){if(this._$cssResult$=!0,a!==_t)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=o}get styleSheet(){let t=this.o,o=this.t;if(lt&&t===void 0){let a=o!==void 0&&o.length===1;a&&(t=Zt.get(o)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),a&&Zt.set(o,t))}return t}toString(){return this.cssText}},Jt=e=>new H(typeof e=="string"?e:e+"",void 0,_t),g=(e,...t)=>{let o=e.length===1?e[0]:t.reduce((a,r,i)=>a+(n=>{if(n._$cssResult$===!0)return n.cssText;if(typeof n=="number")return n;throw Error("Value passed to 'css' function must be a 'css' function result: "+n+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(r)+e[i+1],e[0]);return new H(o,e,_t)},Qt=(e,t)=>{if(lt)e.adoptedStyleSheets=t.map(o=>o instanceof CSSStyleSheet?o:o.styleSheet);else for(let o of t){let a=document.createElement("style"),r=st.litNonce;r!==void 0&&a.setAttribute("nonce",r),a.textContent=o.cssText,e.appendChild(a)}},At=lt?e=>e:e=>e instanceof CSSStyleSheet?(t=>{let o="";for(let a of t.cssRules)o+=a.cssText;return Jt(o)})(e):e;var{is:Ze,defineProperty:Je,getOwnPropertyDescriptor:Qe,getOwnPropertyNames:to,getOwnPropertySymbols:eo,getPrototypeOf:oo}=Object,ct=globalThis,te=ct.trustedTypes,ao=te?te.emptyScript:"",ro=ct.reactiveElementPolyfillSupport,j=(e,t)=>e,W={toAttribute(e,t){switch(t){case Boolean:e=e?ao:null;break;case Object:case Array:e=e==null?e:JSON.stringify(e)}return e},fromAttribute(e,t){let o=e;switch(t){case Boolean:o=e!==null;break;case Number:o=e===null?null:Number(e);break;case Object:case Array:try{o=JSON.parse(e)}catch{o=null}}return o}},dt=(e,t)=>!Ze(e,t),ee={attribute:!0,type:String,converter:W,reflect:!1,useDefault:!1,hasChanged:dt};Symbol.metadata??=Symbol("metadata"),ct.litPropertyMetadata??=new WeakMap;var z=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,o=ee){if(o.state&&(o.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((o=Object.create(o)).wrapped=!0),this.elementProperties.set(t,o),!o.noAccessor){let a=Symbol(),r=this.getPropertyDescriptor(t,a,o);r!==void 0&&Je(this.prototype,t,r)}}static getPropertyDescriptor(t,o,a){let{get:r,set:i}=Qe(this.prototype,t)??{get(){return this[o]},set(n){this[o]=n}};return{get:r,set(n){let d=r?.call(this);i?.call(this,n),this.requestUpdate(t,d,a)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??ee}static _$Ei(){if(this.hasOwnProperty(j("elementProperties")))return;let t=oo(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(j("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(j("properties"))){let o=this.properties,a=[...to(o),...eo(o)];for(let r of a)this.createProperty(r,o[r])}let t=this[Symbol.metadata];if(t!==null){let o=litPropertyMetadata.get(t);if(o!==void 0)for(let[a,r]of o)this.elementProperties.set(a,r)}this._$Eh=new Map;for(let[o,a]of this.elementProperties){let r=this._$Eu(o,a);r!==void 0&&this._$Eh.set(r,o)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){let o=[];if(Array.isArray(t)){let a=new Set(t.flat(1/0).reverse());for(let r of a)o.unshift(At(r))}else t!==void 0&&o.push(At(t));return o}static _$Eu(t,o){let a=o.attribute;return a===!1?void 0:typeof a=="string"?a:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$EO??=new Set).add(t),this.renderRoot!==void 0&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){let t=new Map,o=this.constructor.elementProperties;for(let a of o.keys())this.hasOwnProperty(a)&&(t.set(a,this[a]),delete this[a]);t.size>0&&(this._$Ep=t)}createRenderRoot(){let t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Qt(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,o,a){this._$AK(t,a)}_$ET(t,o){let a=this.constructor.elementProperties.get(t),r=this.constructor._$Eu(t,a);if(r!==void 0&&a.reflect===!0){let i=(a.converter?.toAttribute!==void 0?a.converter:W).toAttribute(o,a.type);this._$Em=t,i==null?this.removeAttribute(r):this.setAttribute(r,i),this._$Em=null}}_$AK(t,o){let a=this.constructor,r=a._$Eh.get(t);if(r!==void 0&&this._$Em!==r){let i=a.getPropertyOptions(r),n=typeof i.converter=="function"?{fromAttribute:i.converter}:i.converter?.fromAttribute!==void 0?i.converter:W;this._$Em=r;let d=n.fromAttribute(o,i.type);this[r]=d??this._$Ej?.get(r)??d,this._$Em=null}}requestUpdate(t,o,a,r=!1,i){if(t!==void 0){let n=this.constructor;if(r===!1&&(i=this[t]),a??=n.getPropertyOptions(t),!((a.hasChanged??dt)(i,o)||a.useDefault&&a.reflect&&i===this._$Ej?.get(t)&&!this.hasAttribute(n._$Eu(t,a))))return;this.C(t,o,a)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(t,o,{useDefault:a,reflect:r,wrapped:i},n){a&&!(this._$Ej??=new Map).has(t)&&(this._$Ej.set(t,n??o??this[t]),i!==!0||n!==void 0)||(this._$AL.has(t)||(this.hasUpdated||a||(o=void 0),this._$AL.set(t,o)),r===!0&&this._$Em!==t&&(this._$Eq??=new Set).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(o){Promise.reject(o)}let t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[r,i]of this._$Ep)this[r]=i;this._$Ep=void 0}let a=this.constructor.elementProperties;if(a.size>0)for(let[r,i]of a){let{wrapped:n}=i,d=this[r];n!==!0||this._$AL.has(r)||d===void 0||this.C(r,void 0,i,d)}}let t=!1,o=this._$AL;try{t=this.shouldUpdate(o),t?(this.willUpdate(o),this._$EO?.forEach(a=>a.hostUpdate?.()),this.update(o)):this._$EM()}catch(a){throw t=!1,this._$EM(),a}t&&this._$AE(o)}willUpdate(t){}_$AE(t){this._$EO?.forEach(o=>o.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&=this._$Eq.forEach(o=>this._$ET(o,this[o])),this._$EM()}updated(t){}firstUpdated(t){}};z.elementStyles=[],z.shadowRootOptions={mode:"open"},z[j("elementProperties")]=new Map,z[j("finalized")]=new Map,ro?.({ReactiveElement:z}),(ct.reactiveElementVersions??=[]).push("2.1.2");var kt=globalThis,oe=e=>e,mt=kt.trustedTypes,ae=mt?mt.createPolicy("lit-html",{createHTML:e=>e}):void 0,Et="$lit$",$=`lit$${Math.random().toFixed(9).slice(2)}$`,Mt="?"+$,io=`<${Mt}>`,P=document,Y=()=>P.createComment(""),K=e=>e===null||typeof e!="object"&&typeof e!="function",Ft=Array.isArray,ce=e=>Ft(e)||typeof e?.[Symbol.iterator]=="function",St=`[ 	
\f\r]`,X=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,re=/-->/g,ie=/>/g,I=RegExp(`>|${St}(?:([^\\s"'>=/]+)(${St}*=${St}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),ne=/'/g,se=/"/g,de=/^(?:script|style|textarea|title)$/i,It=e=>(t,...o)=>({_$litType$:e,strings:t,values:o}),_=It(1),me=It(2),he=It(3),y=Symbol.for("lit-noChange"),p=Symbol.for("lit-nothing"),le=new WeakMap,q=P.createTreeWalker(P,129);function ue(e,t){if(!Ft(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return ae!==void 0?ae.createHTML(t):t}var fe=(e,t)=>{let o=e.length-1,a=[],r,i=t===2?"<svg>":t===3?"<math>":"",n=X;for(let d=0;d<o;d++){let c=e[d],h,f,u=-1,x=0;for(;x<c.length&&(n.lastIndex=x,f=n.exec(c),f!==null);)x=n.lastIndex,n===X?f[1]==="!--"?n=re:f[1]!==void 0?n=ie:f[2]!==void 0?(de.test(f[2])&&(r=RegExp("</"+f[2],"g")),n=I):f[3]!==void 0&&(n=I):n===I?f[0]===">"?(n=r??X,u=-1):f[1]===void 0?u=-2:(u=n.lastIndex-f[2].length,h=f[1],n=f[3]===void 0?I:f[3]==='"'?se:ne):n===se||n===ne?n=I:n===re||n===ie?n=X:(n=I,r=void 0);let E=n===I&&e[d+1].startsWith("/>")?" ":"";i+=n===X?c+io:u>=0?(a.push(h),c.slice(0,u)+Et+c.slice(u)+$+E):c+$+(u===-2?d:E)}return[ue(e,i+(e[o]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),a]},G=class e{constructor({strings:t,_$litType$:o},a){let r;this.parts=[];let i=0,n=0,d=t.length-1,c=this.parts,[h,f]=fe(t,o);if(this.el=e.createElement(h,a),q.currentNode=this.el.content,o===2||o===3){let u=this.el.content.firstChild;u.replaceWith(...u.childNodes)}for(;(r=q.nextNode())!==null&&c.length<d;){if(r.nodeType===1){if(r.hasAttributes())for(let u of r.getAttributeNames())if(u.endsWith(Et)){let x=f[n++],E=r.getAttribute(u).split($),rt=/([.?@])?(.*)/.exec(x);c.push({type:1,index:i,name:rt[2],strings:E,ctor:rt[1]==="."?ut:rt[1]==="?"?ft:rt[1]==="@"?pt:B}),r.removeAttribute(u)}else u.startsWith($)&&(c.push({type:6,index:i}),r.removeAttribute(u));if(de.test(r.tagName)){let u=r.textContent.split($),x=u.length-1;if(x>0){r.textContent=mt?mt.emptyScript:"";for(let E=0;E<x;E++)r.append(u[E],Y()),q.nextNode(),c.push({type:2,index:++i});r.append(u[x],Y())}}}else if(r.nodeType===8)if(r.data===Mt)c.push({type:2,index:i});else{let u=-1;for(;(u=r.data.indexOf($,u+1))!==-1;)c.push({type:7,index:i}),u+=$.length-1}i++}}static createElement(t,o){let a=P.createElement("template");return a.innerHTML=t,a}};function R(e,t,o=e,a){if(t===y)return t;let r=a!==void 0?o._$Co?.[a]:o._$Cl,i=K(t)?void 0:t._$litDirective$;return r?.constructor!==i&&(r?._$AO?.(!1),i===void 0?r=void 0:(r=new i(e),r._$AT(e,o,a)),a!==void 0?(o._$Co??=[])[a]=r:o._$Cl=r),r!==void 0&&(t=R(e,r._$AS(e,t.values),r,a)),t}var ht=class{constructor(t,o){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=o}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:o},parts:a}=this._$AD,r=(t?.creationScope??P).importNode(o,!0);q.currentNode=r;let i=q.nextNode(),n=0,d=0,c=a[0];for(;c!==void 0;){if(n===c.index){let h;c.type===2?h=new O(i,i.nextSibling,this,t):c.type===1?h=new c.ctor(i,c.name,c.strings,this,t):c.type===6&&(h=new wt(i,this,t)),this._$AV.push(h),c=a[++d]}n!==c?.index&&(i=q.nextNode(),n++)}return q.currentNode=P,r}p(t){let o=0;for(let a of this._$AV)a!==void 0&&(a.strings!==void 0?(a._$AI(t,a,o),o+=a.strings.length-2):a._$AI(t[o])),o++}},O=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,o,a,r){this.type=2,this._$AH=p,this._$AN=void 0,this._$AA=t,this._$AB=o,this._$AM=a,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,o=this._$AM;return o!==void 0&&t?.nodeType===11&&(t=o.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,o=this){t=R(this,t,o),K(t)?t===p||t==null||t===""?(this._$AH!==p&&this._$AR(),this._$AH=p):t!==this._$AH&&t!==y&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):ce(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==p&&K(this._$AH)?this._$AA.nextSibling.data=t:this.T(P.createTextNode(t)),this._$AH=t}$(t){let{values:o,_$litType$:a}=t,r=typeof a=="number"?this._$AC(t):(a.el===void 0&&(a.el=G.createElement(ue(a.h,a.h[0]),this.options)),a);if(this._$AH?._$AD===r)this._$AH.p(o);else{let i=new ht(r,this),n=i.u(this.options);i.p(o),this.T(n),this._$AH=i}}_$AC(t){let o=le.get(t.strings);return o===void 0&&le.set(t.strings,o=new G(t)),o}k(t){Ft(this._$AH)||(this._$AH=[],this._$AR());let o=this._$AH,a,r=0;for(let i of t)r===o.length?o.push(a=new e(this.O(Y()),this.O(Y()),this,this.options)):a=o[r],a._$AI(i),r++;r<o.length&&(this._$AR(a&&a._$AB.nextSibling,r),o.length=r)}_$AR(t=this._$AA.nextSibling,o){for(this._$AP?.(!1,!0,o);t!==this._$AB;){let a=oe(t).nextSibling;oe(t).remove(),t=a}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}},B=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,o,a,r,i){this.type=1,this._$AH=p,this._$AN=void 0,this.element=t,this.name=o,this._$AM=r,this.options=i,a.length>2||a[0]!==""||a[1]!==""?(this._$AH=Array(a.length-1).fill(new String),this.strings=a):this._$AH=p}_$AI(t,o=this,a,r){let i=this.strings,n=!1;if(i===void 0)t=R(this,t,o,0),n=!K(t)||t!==this._$AH&&t!==y,n&&(this._$AH=t);else{let d=t,c,h;for(t=i[0],c=0;c<i.length-1;c++)h=R(this,d[a+c],o,c),h===y&&(h=this._$AH[c]),n||=!K(h)||h!==this._$AH[c],h===p?t=p:t!==p&&(t+=(h??"")+i[c+1]),this._$AH[c]=h}n&&!r&&this.j(t)}j(t){t===p?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},ut=class extends B{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===p?void 0:t}},ft=class extends B{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==p)}},pt=class extends B{constructor(t,o,a,r,i){super(t,o,a,r,i),this.type=5}_$AI(t,o=this){if((t=R(this,t,o,0)??p)===y)return;let a=this._$AH,r=t===p&&a!==p||t.capture!==a.capture||t.once!==a.once||t.passive!==a.passive,i=t!==p&&(a===p||r);r&&this.element.removeEventListener(this.name,this,a),i&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},wt=class{constructor(t,o,a){this.element=t,this.type=6,this._$AN=void 0,this._$AM=o,this.options=a}get _$AU(){return this._$AM._$AU}_$AI(t){R(this,t)}},pe={M:Et,P:$,A:Mt,C:1,L:fe,R:ht,D:ce,V:R,I:O,H:B,N:ft,U:pt,B:ut,F:wt},no=kt.litHtmlPolyfillSupport;no?.(G,O),(kt.litHtmlVersions??=[]).push("3.3.3");var we=(e,t,o)=>{let a=o?.renderBefore??t,r=a._$litPart$;if(r===void 0){let i=o?.renderBefore??null;a._$litPart$=r=new O(t.insertBefore(Y(),i),i,void 0,o??{})}return r._$AI(e),r};var qt=globalThis,M=class extends z{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){let o=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=we(o,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return y}};M._$litElement$=!0,M.finalized=!0,qt.litElementHydrateSupport?.({LitElement:M});var so=qt.litElementPolyfillSupport;so?.({LitElement:M});(qt.litElementVersions??=[]).push("4.2.2");var F=e=>(t,o)=>{o!==void 0?o.addInitializer(()=>{customElements.define(e,t)}):customElements.define(e,t)};var lo={attribute:!0,type:String,converter:W,reflect:!1,hasChanged:dt},co=(e=lo,t,o)=>{let{kind:a,metadata:r}=o,i=globalThis.litPropertyMetadata.get(r);if(i===void 0&&globalThis.litPropertyMetadata.set(r,i=new Map),a==="setter"&&((e=Object.create(e)).wrapped=!0),i.set(o.name,e),a==="accessor"){let{name:n}=o;return{set(d){let c=t.get.call(this);t.set.call(this,d),this.requestUpdate(n,c,e,!0,d)},init(d){return d!==void 0&&this.C(n,void 0,e,d),d}}}if(a==="setter"){let{name:n}=o;return function(d){let c=this[n];t.call(this,d),this.requestUpdate(n,c,e,!0,d)}}throw Error("Unsupported decorator location: "+a)};function l(e){return(t,o)=>typeof o=="object"?co(e,t,o):((a,r,i)=>{let n=r.hasOwnProperty(i);return r.constructor.createProperty(i,a),n?Object.getOwnPropertyDescriptor(r,i):void 0})(e,t,o)}function Z(e){return l({...e,state:!0,attribute:!1})}var T=(e,t,o)=>(o.configurable=!0,o.enumerable=!0,Reflect.decorate&&typeof t!="object"&&Object.defineProperty(e,t,o),o);function J(e,t){return(o,a,r)=>{let i=n=>n.renderRoot?.querySelector(e)??null;if(t){let{get:n,set:d}=typeof a=="object"?o:r??(()=>{let c=Symbol();return{get(){return this[c]},set(h){this[c]=h}}})();return T(o,a,{get(){let c=n.call(this);return c===void 0&&(c=i(this),(c!==null||this.hasUpdated)&&d.call(this,c)),c}})}return T(o,a,{get(){return i(this)}})}}var mo=g`
  :host {
...
`;function L(e,t){let o={waitUntilFirstUpdate:!1,...t};return(a,r)=>{let{update:i}=a,n=Array.isArray(e)?e:[e];a.update=function(d){n.forEach(c=>{let h=c;if(d.has(h)){let f=d.get(h),u=this[h];f!==u&&(!o.waitUntilFirstUpdate||this.hasUpdated)&&this[r](f,u)}}),i.call(this,d)}}}var Pt=new Set,V=new Map,S,Rt="ltr",Bt="en",Le=typeof MutationObserver<"u"&&typeof document<"u"&&typeof document.documentElement<"u";if(Le){let e=new MutationObserver(xe);Rt=document.documentElement.dir||"ltr",Bt=document.documentElement.lang||navigator.language,e.observe(document.documentElement,{attributes:!0,attributeFilter:["dir","lang"]})}function Q(...e){e.map(t=>{let o=t.$code.toLowerCase();V.has(o)?V.set(o,Object.assign(Object.assign({},V.get(o)),t)):V.set(o,t),S||(S=t)}),xe()}function xe(){Le&&(Rt=document.documentElement.dir||"ltr",Bt=document.documentElement.lang||navigator.language),[...Pt.keys()].map(e=>{typeof e.requestUpdate=="function"&&e.requestUpdate()})}var Ct=class{constructor(t){this.host=t,this.host.addController(this)}hostConnected(){Pt.add(this.host)}hostDisconnected(){Pt.delete(this.host)}dir(){return`${this.host.dir||Rt}`.toLowerCase()}lang(){let t=`${this.host.lang||Bt}`.toLowerCase().replace(/_/g,"-");try{return new Intl.Locale(t),t}catch{return S?S.$code.toLowerCase():"en"}}getTranslationData(t){var o,a;let r;try{r=new Intl.Locale(t.replace(/_/g,"-"))}catch{return{locale:void 0,language:"",region:"",primary:void 0,secondary:void 0}}let i=r.language.toLowerCase(),n=(a=(o=r.region)===null||o===void 0?void 0:o.toLowerCase())!==null&&a!==void 0?a:"",d=V.get(`${i}-${n}`),c=V.get(i);return{locale:r,language:i,region:n,primary:d,secondary:c}}exists(t,o){var a;let{primary:r,secondary:i}=this.getTranslationData((a=o.lang)!==null&&a!==void 0?a:this.lang());return o=Object.assign({includeFallback:!1},o),!!(r&&r[t]||i&&i[t]||o.includeFallback&&S&&S[t])}term(t,...o){let{primary:a,secondary:r}=this.getTranslationData(this.lang()),i;if(a&&a[t])i=a[t];else if(r&&r[t])i=r[t];else if(S&&S[t])i=S[t];else return console.error(`No translation found for: ${String(t)}`),String(t);return typeof i=="function"?i(...o):i}date(t,o){return t=new Date(t),new Intl.DateTimeFormat(this.lang(),o).format(t)}number(t,o){return t=Number(t),isNaN(t)?"":new Intl.NumberFormat(this.lang(),o).format(t)}relativeTime(t,o,a){return new Intl.RelativeTimeFormat(this.lang(),a).format(t,o)}};var ze={$code:"en",$name:"English",$dir:"ltr",am:"AM",autosizeColumn:"Autosize column",captions:"Captions",carousel:"Carousel",chooseDate:"Choose date",chooseDecade:"Choose decade",chooseMonth:"Choose month",chooseTime:"Choose time",chooseYear:"Choose year",clearEntry:"Clear entry",clearFilter:"Clear filter",clearSort:"Clear sort",close:"Close",closeCalendar:"Close calendar",closeTimeInput:"Close time picker",collapseRow:"Collapse row",columnMenu:"Column options",columnMovedToPosition:(e,t,o)=>`${e} moved to position ${t} of ${o}`,columns:"Columns",compactPageXOfY:(e,t)=>`${e} of ${t}`,copied:"Copied",copy:"Copy",createOption:e=>`Create "${e}"`,currentlyPlaying:"currently playing",currentValue:"Current value",date:"Date",datePickerKeyboardHelp:"Use arrow keys to change values; press Alt+Down Arrow to open the calendar.",day:"Day",dayPeriod:"AM/PM",decrement:"Decrement",deselectAllRows:"Deselect all rows",dropFileHere:"Drop file here or click to browse",dropFilesHere:"Drop files here or click to browse",empty:"Empty",endDate:"End date",enterFullscreen:"Enter fullscreen",error:"Error",exitFullscreen:"Exit fullscreen",expandRow:"Expand row",filterByColumn:e=>`Filter by ${e}`,filterFrom:"From",filterMax:"Max",filterMin:"Min",filterTo:"To",firstPage:"First page",goToSlide:(e,t)=>`Go to slide ${e} of ${t}`,hideColumn:"Hide column",hidePassword:"Hide password",hour:"Hour",incompleteDate:"Enter a valid date.",increment:"Increment",jumpBackwardX:e=>`Jump back ${e} pages`,jumpForwardX:e=>`Jump forward ${e} pages`,lastPage:"Last page",loading:"Loading",minute:"Minute",month:"Month",moreOptions:"More Options",mute:"Mute",nextDecade:"Next decade",nextMonth:"Next month",nextPage:"Next page",nextSlide:"Next slide",nextVideo:"Next Video",nextYear:"Next year",noData:"No data",noResults:"No matching results",now:"Now",numCharacters:e=>e===1?"1 character":`${e} characters`,numCharactersRemaining:e=>e===1?"1 character remaining":`${e} characters remaining`,numOptionsSelected:e=>e===0?"No options selected":e===1?"1 option selected":`${e} options selected`,numRowsCopied:e=>e===1?"1 row copied":`${e} rows copied`,numRowsSelected:e=>e===1?"1 row selected":`${e} rows selected`,pageXOfY:(e,t)=>`Page ${e} of ${t}`,pagination:"Pagination",pause:"Pause",pauseAnimation:"Pause animation",pictureInPicture:"Picture in picture",pinLeft:"Pin left",pinRight:"Pin right",play:"Play",playAnimation:"Play animation",playbackSpeed:"Playback speed",playlist:"Playlist",pm:"PM",previousDecade:"Previous decade",previousMonth:"Previous month",previousPage:"Previous page",previousSlide:"Previous slide",previousVideo:"Previous video",previousYear:"Previous year",progress:"Progress",rangeTooLong:e=>e===1?"Select a range no longer than 1 day":`Select a range no longer than ${e} days`,rangeTooShort:e=>e===1?"Select a range at least 1 day long":`Select a range at least ${e} days long`,readonly:"Read-only",remove:"Remove",resetColumns:"Reset columns",resize:"Resize",resizeColumn:"Resize column",rowsPerPage:"Rows per page",scrollableRegion:"Scrollable region",scrollToEnd:"Scroll to end",scrollToStart:"Scroll to start",search:"Search",second:"Second",seek:"Seek",seekProgress:(e,t)=>`${e} of ${t}`,selectAColorFromTheScreen:"Select a color from the screen",selectAllRows:"Select all rows",selected:"Selected",selectedDateLabel:e=>`Selected: ${e}`,selectedRangeLabel:e=>`Selected range: ${e}`,selectGroup:"Select group",selectionCleared:"Selection cleared",selectRow:"Select row",showingNofMRows:(e,t)=>`Showing ${e} of ${t} rows`,showingXtoYofZ:(e,t,o)=>`${e}\u2013${t} of ${o}`,showPassword:"Show password",slideNum:e=>`Slide ${e}`,sortAscending:"Sort ascending",sortColumn:"Sort column",sortDescending:"Sort descending",startDate:"Start date",time:"Time",timeInputKeyboardHelp:"Use arrow keys to change values; press Alt+Down Arrow to open the time picker.",today:"Today",toggleColorFormat:"Toggle color format",unmute:"Unmute",unpin:"Unpin",unpinColumn:"Unpin column",videoPlayer:"Video player",volume:"Volume",year:"Year",zoomIn:"Zoom in",zoomOut:"Zoom out"};Q(ze);var $e=ze;var D=class extends Ct{lang(){return this.host.didSSR&&!this.host.hasUpdated?this.host.lang||"en":super.lang()}};Q($e);var k={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Lt=e=>(...t)=>({_$litDirective$:e,values:t}),N=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,o,a){this._$Ct=t,this._$AM=o,this._$Ci=a}_$AS(t,o){return this.update(t,o)}update(t,o){return this.render(...o)}};var tt=Lt(class extends N{constructor(e){if(super(e),e.type!==k.ATTRIBUTE||e.name!=="class"||e.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){if(this.st===void 0){this.st=new Set,e.strings!==void 0&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter(a=>a!=="")));for(let a in t)t[a]&&!this.nt?.has(a)&&this.st.add(a);return this.render(t)}let o=e.element.classList;for(let a of this.st)a in t||(o.remove(a),this.st.delete(a));for(let a in t){let r=!!t[a];r===this.st.has(a)||this.nt?.has(a)||(r?(o.add(a),this.st.add(a)):(o.remove(a),this.st.delete(a)))}return y}});var b=e=>e??p;var Ae=Symbol.for(""),po=e=>{if(e?.r===Ae)return e?._$litStatic$};var Tt=(e,...t)=>({_$litStatic$:t.reduce((o,a,r)=>o+(i=>{if(i._$litStatic$!==void 0)return i._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${i}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)})(a)+e[r+1],e[0]),r:Ae}),_e=new Map,Ut=e=>(t,...o)=>{let a=o.length,r,i,n=[],d=[],c,h=0,f=!1;for(;h<a;){for(c=t[h];h<a&&(i=o[h],(r=po(i))!==void 0);)c+=r+t[++h],f=!0;h!==a&&d.push(i),n.push(c),h++}if(h===a&&n.push(t[a]),f){let u=n.join("$$lit$$");(t=_e.get(u))===void 0&&(n.raw=n,_e.set(u,t=n)),o=d}return e(t,...o)},xt=Ut(_),lr=Ut(me),cr=Ut(he);var m=class extends C{constructor(){super(...arguments),this.assumeInteractionOn=["click"],this.hasSlotController=new bt(this,"[default]","start","end"),this.localize=new D(this),this.invalid=!1,this.isIconButton=!1,this.title="",this.variant="neutral",this.appearance="accent",this.size="m",this.withCaret=!1,this.withStart=!1,this.withEnd=!1,this.disabled=!1,this.loading=!1,this.pill=!1,this.type="button"}static get validators(){return[...super.validators,it()]}handleSizeChange(){gt(this.localName,this.size)}constructLightDOMButton(){let e=document.createElement("button");for(let t of this.attributes)t.name!=="style"&&e.setAttribute(t.name,t.value);return e.type=this.type,e.style.position="absolute !important",e.style.width="0 !important",e.style.height="0 !important",e.style.clipPath="inset(50%) !important",e.style.overflow="hidden !important",e.style.whiteSpace="nowrap !important",this.name&&(e.name=this.name),e.value=this.value||"",e}handleClick(e){if(this.disabled||this.loading){e.preventDefault(),e.stopImmediatePropagation();return}if(this.type!=="submit"&&this.type!=="reset"||!this.getForm())return;let o=this.constructLightDOMButton();this.parentElement?.append(o),o.click(),o.remove()}handleInvalid(){this.dispatchEvent(new nt)}handleLabelSlotChange(){let e=this.labelSlot.assignedNodes({flatten:!0}),t=!1,o=!1,a=!1,r=!1;[...e].forEach(i=>{if(i.nodeType===Node.ELEMENT_NODE){let n=i;n.localName==="wa-icon"?(o=!0,t||(t=n.label!==void 0)):r=!0}else i.nodeType===Node.TEXT_NODE&&(i.textContent?.trim()||"").length>0&&(a=!0)}),this.isIconButton=o&&!a&&!r,this.customStates.set("icon-button",this.isIconButton),this.isIconButton&&!t&&console.warn('Icon buttons must have a label for screen readers. Add <wa-icon label="..."> to remove this warning.',this)}isButton(){return!this.href}isLink(){return!!this.href}handleDisabledChange(){this.customStates.set("disabled",this.disabled),this.updateValidity()}handleHrefChange(){this.customStates.set("link",this.isLink())}handleLoadingChange(){this.customStates.set("loading",this.loading)}setValue(...e){}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}render(){let e=this.isLink(),t=e?Tt`a`:Tt`button`;return xt`
      <${t}
        part="base button"
        class=${tt({button:!0,caret:this.withCaret,disabled:this.disabled,loading:this.loading,rtl:this.localize.dir()==="rtl","has-label":this.hasSlotController.test("[default]"),"has-start":this.hasSlotController.test("start","withStart"),"has-end":this.hasSlotController.test("end","withEnd"),"is-icon-button":this.isIconButton})}
      ...
      >
        ...
        ${this.withCaret?xt`
              ...
              `:""}
        ${this.loading?xt`<wa-spinner part="spinner"></wa-spinner>`:""}
      </${t}>
    `}};m.shadowRootOptions={...C.shadowRootOptions,delegatesFocus:!0};m.css=[ye,Ce,yt];s([J(".button")],m.prototype,"button",2);s([J("slot:not([name])")],m.prototype,"labelSlot",2);s([Z()],m.prototype,"invalid",2);s([Z()],m.prototype,"isIconButton",2);s([l()],m.prototype,"title",2);s([l({reflect:!0})],m.prototype,"variant",2);s([l({reflect:!0})],m.prototype,"appearance",2);s([l({reflect:!0})],m.prototype,"size",2);s([L("size")],m.prototype,"handleSizeChange",1);s([l({attribute:"with-caret",type:Boolean,reflect:!0})],m.prototype,"withCaret",2);s([l({attribute:"with-start",type:Boolean})],m.prototype,"withStart",2);s([l({attribute:"with-end",type:Boolean})],m.prototype,"withEnd",2);s([l({type:Boolean})],m.prototype,"disabled",2);s([l({type:Boolean,reflect:!0})],m.prototype,"loading",2);s([l({type:Boolean,reflect:!0})],m.prototype,"pill",2);s([l()],m.prototype,"type",2);s([l({reflect:!0})],m.prototype,"name",2);s([l({reflect:!0})],m.prototype,"value",2);s([l({reflect:!0})],m.prototype,"href",2);s([l()],m.prototype,"target",2);s([l()],m.prototype,"rel",2);s([l()],m.prototype,"download",2);s([l({attribute:"formaction"})],m.prototype,"formAction",2);s([l({attribute:"formenctype"})],m.prototype,"formEnctype",2);s([l({attribute:"formmethod"})],m.prototype,"formMethod",2);s([l({attribute:"formnovalidate",type:Boolean})],m.prototype,"formNoValidate",2);s([l({attribute:"formtarget"})],m.prototype,"formTarget",2);s([L("disabled",{waitUntilFirstUpdate:!0})],m.prototype,"handleDisabledChange",1);s([L("href")],m.prototype,"handleHrefChange",1);s([L("loading",{waitUntilFirstUpdate:!0})],m.prototype,"handleLoadingChange",1);m=s([F("wa-button")],m);m.disableWarning?.("change-in-update");var Se=g`
  :host {
    --track-width: 2px;
...
`;var Ot=class extends A{constructor(){super(...arguments),this.localize=new D(this)}render(){return _`
      <svg
        part="base spinner"
        role="progressbar"
    ...
    `}};Ot.css=Se;Ot=s([F("wa-spinner")],Ot);var ke=class extends Event{constructor(){super("wa-error",{bubbles:!0,cancelable:!1,composed:!0})}};var Ee=class extends Event{constructor(){super("wa-load",{bubbles:!0,cancelable:!1,composed:!0})}};var Me=g`
  :host {
...
`;var We=Lt(class extends N{constructor(e){if(super(e),e.type!==k.PROPERTY&&e.type!==k.ATTRIBUTE&&e.type!==k.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!De(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===y||t===p)return t;let o=e.element,a=e.name;if(e.type===k.PROPERTY){if(t===o[a])return y}else if(e.type===k.BOOLEAN_ATTRIBUTE){if(!!t===o.hasAttribute(a))return y}else if(e.type===k.ATTRIBUTE&&o.getAttribute(a)===t+"")return y;return Ne(e),t}});var w=class extends C{constructor(){super(...arguments),this.hasSlotController=new bt(this,"hint"),this.localize=new D(this),this.title="",this.name=null,this._value=this.getAttribute("value")??null,this.size="m",this.disabled=!1,this._checked=null,this.defaultChecked=this.hasAttribute("checked"),this.required=!1,this.hint="",this.withHint=!1}static get validators(){return[...super.validators,it()]}get value(){return this._value??"on"}set value(e){this._value=e}handleSizeChange(){gt(this.localName,this.size)}get checked(){return this.valueHasChanged?!!this._checked:this._checked??this.defaultChecked}set checked(e){this._checked=!!e,this.valueHasChanged=!0}handleClick(){this.hasInteracted=!0,this.checked=!this.checked,this.updateComplete.then(()=>{this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0}))})}handleKeyDown(e){let t=this.localize.dir()==="rtl";e.key==="ArrowLeft"&&(e.preventDefault(),this.checked=t,this.updateComplete.then(()=>{this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0})),this.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0}))})),e.key==="ArrowRight"&&(e.preventDefault(),this.checked=!t,this.updateComplete.then(()=>{this.dispatchEvent(new Event("change",{bubbles:!0,composed:!0})),this.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0}))}))}willUpdate(e){super.willUpdate(e),(e.has("value")||e.has("checked")||e.has("defaultChecked")||e.has("disabled"))&&this.handleValueOrCheckedChange()}handleValueOrCheckedChange(){if(this.didSSR&&!this.hasUpdated){this.updateComplete.then(()=>{this.handleValueOrCheckedChange()});return}this.setValue(this.checked?this.value:null,this._value),this.updateValidity()}handleStateChange(){this.hasUpdated&&(this.input.checked=this.checked),this.customStates.set("checked",this.checked),this.updateValidity()}handleDisabledChange(){this.updateValidity()}click(){this.input.click()}focus(e){this.input.focus(e)}blur(){this.input.blur()}setValue(e,t){if(!this.checked){this.internals.setFormValue(null,null);return}this.internals.setFormValue(e??"on",t)}formResetCallback(){this._checked=null,super.formResetCallback(),this.handleValueOrCheckedChange()}render(){let e=this.hasSlotController.test("hint","withHint"),t=this.hint?!0:!!e,o=this.didSSR&&!this.hasUpdated?this.checked:this.defaultChecked,a=this.didSSR&&!this.hasUpdated?null:We(this.checked);return _`
      <label
        part="base switch"
        class=${tt({checked:this.checked,disabled:this.disabled})}
      >
        <input
          class="input"
          type="checkbox"
      ...
      <slot
        ...
        name="hint"
        part="hint"
        class=${tt({"has-slotted":t})}
        aria-hidden=${t?"false":"true"}
        >${this.hint}</slot
      >
    `}};w.shadowRootOptions={...C.shadowRootOptions,delegatesFocus:!0};w.css=[je,yt,He];s([J('input[type="checkbox"]')],w.prototype,"input",2);s([l()],w.prototype,"title",2);s([l({reflect:!0})],w.prototype,"name",2);s([l({reflect:!0})],w.prototype,"value",1);s([l({reflect:!0})],w.prototype,"size",2);s([L("size")],w.prototype,"handleSizeChange",1);s([l({type:Boolean})],w.prototype,"disabled",2);s([l({type:Boolean,attribute:!1})],w.prototype,"checked",1);s([l({type:Boolean,attribute:"checked",reflect:!0})],w.prototype,"defaultChecked",2);s([l({type:Boolean,reflect:!0})],w.prototype,"required",2);s([l({attribute:"hint"})],w.prototype,"hint",2);s([l({attribute:"with-hint",type:Boolean})],w.prototype,"withHint",2);s([L(["checked","defaultChecked"])],w.prototype,"handleStateChange",1);s([L("disabled",{waitUntilFirstUpdate:!0})],w.prototype,"handleDisabledChange",1);w=s([F("wa-switch")],w);w.disableWarning?.("change-in-update");var jt=matchMedia("(prefers-reduced-motion: reduce)"),Xe="applied-ai-interface-motion",ot=!1;try{ot=localStorage.getItem(Xe)==="on"}catch{}var Ye=()=>ot&&!jt.matches&&!document.hidden;function at(){document.documentElement.dataset.motion=Ye()?"on":"off";let e=document.querySelector("#interface-motion");e&&(e.checked=ot);let t=document.querySelector("#motion-note");t&&(t.textContent=jt.matches?"Windows reduced-motion preference is active.":"Subtle color changes on hover. No sliding panels or page animations.")}document.addEventListener("change",e=>{if(e.target.id==="interface-motion"){ot=e.target.checked;try{localStorage.setItem(Xe,ot?"on":"off")}catch{}at()}});jt.addEventListener("change",at);document.addEventListener("visibilitychange",at);window.appEffects={render:at,welcome(){},permitsMotion:Ye};at();})();
